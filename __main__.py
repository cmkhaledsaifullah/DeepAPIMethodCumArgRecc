...
if var == 'train':
    ...
    input_lang = Vocab.load_vocabulary(Vocab, config.input_vocab_file_path, 'Context', input_vocab_size)
    print('Loading Output Vocabulary....')
    output_lang = Vocab.load_vocabulary(Vocab, config.output_vocab_file_path, 'Label', output_vocab_size)
